...
namespace Dorado.Tests.Unit.Resources
{
    public class ResourcesTests
    {
        ...
        {
            ResourceManager manager = Dorado.Resources.Permission.Area.Titles.ResourceManager;
        ...
        {
            ResourceManager manager = Dorado.Resources.Permission.Controller.Titles.ResourceManager;
            using (Context context = new Context())
            {
        ...
        {
            ResourceManager manager = Dorado.Resources.Permission.Action.Titles.ResourceManager;
            using (Context context = new Context())
            {
        ...
        public void Resources_HasEquivalents()
        {
            ...
            IEnumerable<Type> types = Assembly
                .Load("Dorado.Resources")
                .GetTypes()
                .Where(type => type.Namespace.StartsWith("Dorado.Resources."));
