...
$DataProject = "Dorado.Data"
$TestsProject = "Dorado.Tests"
$RazorViewProject = "Dorado.Web"
$ObjectsProject = "Dorado.Objects"
$ServiceProject = "Dorado.Services"
$ValidatorProject = "Dorado.Validators"
$ControllerProject = "Dorado.Controllers"
